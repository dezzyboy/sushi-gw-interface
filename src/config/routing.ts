...
const WRAPPED_NATIVE_ONLY: ChainTokenList = {
  ...
  [ChainId.GODWOKEN]: [WNATIVE[ChainId.GODWOKEN]],
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.GODWOKEN]: [
    ...WRAPPED_NATIVE_ONLY[ChainId.GODWOKEN],
    // GODWOKEN.WBTC,
    GODWOKEN.USDC,
    GODWOKEN.USDT,
    // GODWOKEN.MIM,
...
export const ADDITIONAL_BASES: {
  ...
  // [ChainId.GODWOKEN]: {
  //   // [GODWOKEN.FRAX.address]: [GODWOKEN.FXS],
  //   // [GODWOKEN.FXS.address]: [GODWOKEN.FRAX],
  //   // [GODWOKEN.FLUID.address]: [GODWOKEN.DUSD],
  // },
  [ChainId.MOONRIVER]: {
